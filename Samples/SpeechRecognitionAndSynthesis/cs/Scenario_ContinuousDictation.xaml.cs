...
namespace SDKTemplate
{
    public sealed partial class Scenario_ContinuousDictation : Page
    {
        ...
        private void btnLargerText_Click(object sender, RoutedEventArgs e)
        {
            double fontSize = dictationTextBox.FontSize;
            if (fontSize < 40)
            {
                dictationTextBox.FontSize = fontSize + 2;
            }
        }

        private void btnSmallerText_Click(object sender, RoutedEventArgs e)
        {
            double fontSize = dictationTextBox.FontSize;
            if (fontSize > 8)
            {
